...
insert into public.properties (name, location, city, price, badge, badge_type, type, beds, baths, sqm, image, featured) values
  ...
  ('Kano New Estate Development', 'Nassarawa GRA, Kano', 'Kano', '₦62M', 'Under Construction', 'construction', 'house', 3, 3, 240, 'https://images.unsplash.com/photo-1560184897-6b3a5d1b2d1f?w=700&q=80', false),
  ...
  ('Kano Commercial Land', 'Fagge, Kano', 'Kano', '₦28M', 'Land', 'land', 'land', 0, 0, 750, 'https://images.unsplash.com/photo-1560184897-6b3a5d1b2d1f?w=700&q=80', false);

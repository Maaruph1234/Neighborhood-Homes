  ...
  return (
    ...
    >
      ...
      <FadeIn direction="left" className="relative h-[520px]">
        ...
        >
          <Image src="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80" alt="Luxury interior" fill style={{ objectFit: "cover" }} />
        </motion.div>
        ...
        >
          <Image src="https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=600&q=80" alt="Property exterior" fill style={{ objectFit: "cover" }} />
        </motion.div>
      </FadeIn>
      ...
      <FadeIn direction="right" delay={0.15}>
        ...
        <p className="text-[#6B7280] text-[15px] leading-[1.85] font-light max-w-[500px] mb-10">
          We are Nigeria's premier property ecosystem — connecting buyers, sellers,
          landlords, and tenants with integrity, expertise, and an unmatched portfolio
          of premium real estate across the country.
        </p>

  ...
  return (
    <section className="relative w-full min-h-[52vh] flex items-end overflow-hidden bg-[#071629]">
      <div className="absolute inset-0 z-0">
        <Image src="https://images.unsplash.com/photo-1560520653-9e0e4c89eb11?w=1600&q=80" alt="Our services" fill style={{ objectFit: "cover", opacity: 0.2 }} />
      ...
      {/* Decorative rings removed for a cleaner, premium look */}

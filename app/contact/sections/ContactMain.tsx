          ...
          <FadeIn direction="right" delay={0.15}>
            <div className="border border-[#0B1F3A]/10 bg-white relative overflow-hidden">
              ...
              <div className="p-7">
                ...
                <div className="space-y-4">
                  {[
                    { icon: Phone, label: "Phone", value: "+234 901 328 0477", href: "tel:+234" },
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div><div className="text-[10px] tracking-[0.12em] uppercase text-[#9CA3AF] mb-0.5">WhatsApp</div><a href="https://wa.me/2348130019388" target="_blank" rel="noopener noreferrer" className="text-[13px] text-[#0B1F3A] font-light hover:text-[#C9A84C] transition-colors">+234 813 001 9388</a></div>
                  </div>
                </div>
            ...
            <div className="border border-[#1A4B8C]/20 bg-white relative overflow-hidden">
              ...
              <div className="p-7">
                ...
                <div className="space-y-4">
                  <a href="tel:+234" className="flex items-start gap-3 group"><div className="w-8 h-8 bg-[#F9F6F0] group-hover:bg-[#1A4B8C]/08 flex items-center justify-center flex-shrink-0 transition-colors"><Phone size={12} strokeWidth={1.5} className="stroke-[#1A4B8C]" /></div><div><div className="text-[10px] tracking-[0.12em] uppercase text-[#9CA3AF] mb-0.5">Phone</div><div className="text-[13px] text-[#0B1F3A] font-light group-hover:text-[#1A4B8C] transition-colors">+234 913 176 9300</div></div></a>

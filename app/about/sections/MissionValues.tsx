...
import { Scale, Shield, Zap, Star } from "lucide-react";
...
const values = [
  {
    icon: Scale,
    title: "Integrity",
    text: "Honest and transparent in every transaction. We say what we mean, do what we say, and never cut corners when it comes to our clients' trust.",
  },
  {
    icon: Star,
    title: "Excellence",
    text: "Delivering quality beyond expectations — from the way we present a listing to how we handle post-sale follow-up, we pursue excellence in every detail.",
  },
  {
    icon: Shield,
    title: "Trust",
    text: "Building relationships that last beyond the deal. Our clients come back and refer others because they know we will always put their interests first.",
  },
  {
    icon: Zap,
    title: "Innovation",
    text: "Embracing modern solutions in real estate — from digital listings to seamless documentation, we bring fresh thinking to an industry that needs it.",
  },
];
    ...
    <section className="bg-[#F9F6F0] px-[5vw] py-28">
      <div className="max-w-7xl mx-auto">
        ...
        <FadeIn className="max-w-4xl mx-auto text-center mb-24">
          ...
          >
            "To provide reliable, innovative, and client-centered real estate services
            that create lasting value for property buyers, sellers, and investors
            across Nigeria."
          </blockquote>

        ...
        <FadeIn direction="right" delay={0.15} className="lg:pl-8">
          ...
          <div className="space-y-5 text-[15px] text-[#6B7280] leading-[1.85] font-light">
            <p>
              ...
              specializing in land sales, property brokerage, and the development of
              residential and commercial properties. We are committed to delivering
              trusted, transparent, and value-driven real estate solutions that
              empower individuals, families, and investors to make confident property
              decisions across Nigeria.
            </p>
            <p>
              Our approach combines local market expertise with a client-centered
              process: from the first enquiry to handing over the keys, we provide
              clear guidance, reliable documentation, and access to legal and
              investment professionals within our ecosystem.
            </p>
          </div>
          {/* Inline stats */}
